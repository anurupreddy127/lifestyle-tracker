...
const TYPE_FILTERS = [
  ...
  { value: "expense", label: "Expense", icon: "shopping_bag", color: "bg-rose-500/100", activeText: "text-white" },
  { value: "income", label: "Income", icon: "work", color: "bg-emerald-500/100", activeText: "text-white" },
  { value: "transfer", label: "Transfer", icon: "swap_horiz", color: "bg-amber-500/100", activeText: "text-white" },
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            >
              ...
              {activeFilterCount > 0 && (
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-rose-500/100 text-white text-[9px] font-bold rounded-full flex items-center justify-center">
                  {activeFilterCount}
                </span>
              )}
            </button>
                ...
                <div className="bg-bg-card border border-border rounded-2xl p-3 mb-3 flex flex-col gap-3">
                  ...
                  {activeFilterCount > 0 && (
                    <button
                      ...
                      className="text-xs font-semibold text-rose-400 self-end"
                    >
                      Clear All Filters
                    </button>
                  )}
            ...
            <div className="flex gap-1.5 flex-wrap mb-2">
              {filterCategory && (
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1 bg-finance/15 text-finance rounded-full text-[11px] font-semibold"
                >
          ...
          {txType === "subscription" ? (
            ...
            <>
              ...
              <div>
                ...
                {fieldErrors.account && <p className="text-xs text-rose-400 mt-1">{fieldErrors.account}</p>}
              </div>
                ...
                <>
                  ...
                  {txTransferTarget === "account" ? (
                    <div>
                      ...
                      {fieldErrors.toAccount && <p className="text-xs text-rose-400 mt-1">{fieldErrors.toAccount}</p>}
                    </div>
                  ) : (
                    <div>
                  ...
                  {showDeleteConfirm ? (
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <button
                        ...
                        disabled={saving}
                        className="px-4 py-2.5 rounded-xl text-sm font-semibold bg-rose-500/100 text-white active:bg-rose-600 disabled:opacity-50"
                      >
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl text-sm font-semibold border-2 border-rose-500/20 text-rose-400 active:bg-rose-500/10"
                    >
                      Delete Transaction
                    </button>
                  )}
